    ...
    <div class="row">
        <div class="col-md-12">
            <div class="jumbotron">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <form role="form" method="post" action="index.php?page=soli">
                                                            ...
                                                            <input type="submit" id="asesor1" value="David" name="asesor1" class="btn btn-primary btn-lg"></input>
                                                            <input type="submit" id="asesor2" value="Levi" name="asesor2" class="btn btn-success btn-lg"></input>
                                                            <input type="submit" id="asesor3" value="Osvaldo" name="asesor3" class="btn btn-info btn-lg"></input>
                ...
                </div><!--Cierra container del jumbotron-->
